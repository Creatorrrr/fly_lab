...
C **0.6.0**에서 BANC 하중·부착·방향 감각, 시각 입력 단위, 정지 집단, 회피 판정을 수정했습니다.
[수정 계획](docs/C06_REPAIR_PLAN_20260910.md)과
[수정·실제 검증 결과 및 실행 방법](docs/C06_REPAIR_RESULTS_20260910.md)을 확인하세요.
